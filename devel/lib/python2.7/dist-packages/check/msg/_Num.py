...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.spoi.header.seq, _x.spoi.header.stamp.secs, _x.spoi.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.spoi.header.seq, _x.spoi.header.stamp.secs, _x.spoi.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
